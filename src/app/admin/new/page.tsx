      ...
      <div className="bg-white border rounded-lg p-8 space-y-6">
        <div>
          ...
          <div className="space-y-4">
            ...
            <Input label="Description" value={description} onChange={(e) => setDescription(e.target.value)} isRequired />

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Product Images</label>
              <FileUpload.Root>
                <FileUpload.DropZone maxSize={10 * 1024 * 1024} hint="Drag and drop images here" onDropFiles={handleDropFiles} onSizeLimitExceed={() => alert('File too large')} />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Input label="Reserve Price (GHS)" type="number" value={reservePrice} onChange={(e) => setReservePrice(e.target.value)} />
          </div>
        </div>
