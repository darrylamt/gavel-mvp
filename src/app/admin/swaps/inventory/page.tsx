...
export default function AdminSwapInventoryPage() {
        ...
        <div className="rounded-2xl border border-gray-100 bg-white px-5 py-4 shadow-sm">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Swap Inventory</h1>
            ...
            <table className="w-full text-sm text-gray-700">
              ...
              <tbody className="divide-y divide-gray-50">
                {inventory.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className={`transition-colors ${isEditing ? 'bg-orange-50/40' : 'hover:bg-orange-50/20'}`}>
                      ...
                      <td className="px-5 py-3.5">
                        {isEditing ? (
                          <input
                            ...
                            className="w-20 rounded-lg border border-gray-200 px-2 py-1 text-sm focus:border-orange-400 focus:outline-none"
                          />
                        ) : item.storage}
                      </td>
                      <td className="px-5 py-3.5">
                        {isEditing ? (
                          <input
                            ...
                            className="w-28 rounded-lg border border-gray-200 px-2 py-1 text-sm focus:border-orange-400 focus:outline-none"
                          />
                        ) : item.color}
                      </td>
                      <td className="px-5 py-3.5">
                      ...
                      <td className="px-5 py-3.5">
                        {isEditing ? (
                          <input
                            ...
                            className="w-24 rounded-lg border border-gray-200 px-2 py-1 text-sm focus:border-orange-400 focus:outline-none"
                          />
                      ...
                      <td className="px-5 py-3.5">
                        {isEditing ? (
                          <input
                            ...
                            className="w-16 rounded-lg border border-gray-200 px-2 py-1 text-sm focus:border-orange-400 focus:outline-none"
                          />
                        ) : item.quantity}
                      </td>
                      <td className="px-5 py-3.5">
                          ...
                          {isEditing ? (
                            <>
                              <button
                                ...
                                disabled={actionBusy}
                                className="rounded-lg bg-orange-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-orange-700 disabled:opacity-50 transition-colors"
                              >
