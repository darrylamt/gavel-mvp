...
import { CalendarClock, AlertCircle, CheckCircle2, X, Wallet, Smartphone, CreditCard, User } from 'lucide-react'
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Scheduled phone swap handovers</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="rounded-xl border border-gray-200 px-3 py-2 text-sm focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-100"
              />
              {dateFilter && (
                <button
                        ...
                        <div className="flex-1 space-y-2 min-w-0">
                          ...
                          {appt.remaining_balance !== undefined && (
                            <div className="inline-flex items-center gap-2 rounded-xl bg-blue-50 px-3 py-2">
                              ...
                              <div>
                                <p className="text-xs font-medium text-blue-500">Balance to Collect</p>
                          ...
                          <div className="rounded-xl border border-gray-100 bg-gray-50 px-3 py-2.5">
                            <p className="mb-1.5 text-xs font-semibold uppercase tracking-wide text-gray-400">What to bring</p>
                            <ul className="space-y-1 text-xs text-gray-600">
                              <li className="flex items-center gap-1.5">
                                <Smartphone className="h-3 w-3 text-blue-400" />
                                Trade-in phone (factory reset preferred)
                              </li>
                              <li className="flex items-center gap-1.5">
                      ...
                      {appt.status !== 'completed' && (
                        <div className="flex shrink-0 flex-wrap gap-2">
                          ...
                          <button
                            ...
                            disabled={actionBusy === appt.id}
                            className="rounded-xl border border-gray-200 px-3 py-2 text-xs font-medium text-gray-700 hover:border-blue-300 hover:text-blue-600 disabled:opacity-50 transition-colors"
                          >
                            Arrival Mismatch
                          </button>
                        </div>
