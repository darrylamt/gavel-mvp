...
export default function PartnerModelsPage() {
      ...
      <div className="sm:col-span-2 lg:col-span-3">
        ...
        <div className="flex flex-wrap gap-2 mb-2">
          {f.rear_cameras.map((cam) => (
            <span key={cam} className="inline-flex items-center gap-1 rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-700">
  ...
  return (
    <PartnerShell>
      <div className="space-y-4">
        ...
        {/* Edit form */}
        {editingId && editForm && (
          <div className="rounded-2xl border border-blue-100 bg-blue-50/30 px-5 py-4 shadow-sm">
          ...
          <div className="overflow-x-auto rounded-2xl border border-gray-100 bg-white shadow-sm">
            <table className="w-full text-sm text-gray-700">
              ...
              <tbody className="divide-y divide-gray-50">
                {models.map((m) => (
                  <tr key={m.id} className="transition-colors hover:bg-blue-50/20">
